...
class MusicGenresControllerTests(ControllerTestBase):
    @classmethod
    def setUpClass(cls):
        super(MusicGenresControllerTests, cls).setUpClass()
        cls.controller = cls.client.music_genres
    ...
    def test_get_music_genres(self):
        ...
        result = self.controller.get_music_genres(
            start_index,
            limit,
            search_term,
            parent_id,
    ...
    # Gets all music genres from a given item, folder, or the entire library.
    def test_get_music_genres_1(self):
        # Parameters for the API call
        start_index = None
        limit = None
        search_term = None
    ...
    # Gets all music genres from a given item, folder, or the entire library.
    def test_get_music_genres_2(self):
        # Parameters for the API call
        start_index = None
        limit = None
        search_term = None
