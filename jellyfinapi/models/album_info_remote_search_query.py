...
from jellyfinapi.models.album_info import AlbumInfo
from jellyfinapi.utilities.xml_utilities import XmlUtilities


class AlbumInfoRemoteSearchQuery(object):

    """Implementation of the 'AlbumInfoRemoteSearchQuery' model.

    TODO: type model description here.

    Attributes:
        search_info (AlbumInfo): TODO: type description here.
    ...
    def __init__(
        ...
        """Constructor for the AlbumInfoRemoteSearchQuery class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        if "SearchInfo" in dictionary.keys():
            search_info = (
                AlbumInfo.from_dictionary(dictionary.get("SearchInfo"))
    ...
    def to_xml_sub_element(self, root):
        ...
        """
        XmlUtilities.add_as_subelement(root, self.search_info, "AlbumInfo")
