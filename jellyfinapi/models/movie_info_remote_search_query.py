...
from jellyfinapi.models.movie_info import MovieInfo
from jellyfinapi.utilities.xml_utilities import XmlUtilities


class MovieInfoRemoteSearchQuery(object):

    """Implementation of the 'MovieInfoRemoteSearchQuery' model.

    TODO: type model description here.

    Attributes:
        search_info (MovieInfo): TODO: type description here.
    ...
    def __init__(
        ...
        """Constructor for the MovieInfoRemoteSearchQuery class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        if "SearchInfo" in dictionary.keys():
            search_info = (
                MovieInfo.from_dictionary(dictionary.get("SearchInfo"))
    ...
    def to_xml_sub_element(self, root):
        ...
        """
        XmlUtilities.add_as_subelement(root, self.search_info, "MovieInfo")
