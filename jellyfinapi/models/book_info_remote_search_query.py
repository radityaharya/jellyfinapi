...
from jellyfinapi.models.book_info import BookInfo
from jellyfinapi.utilities.xml_utilities import XmlUtilities


class BookInfoRemoteSearchQuery(object):

    """Implementation of the 'BookInfoRemoteSearchQuery' model.

    TODO: type model description here.

    Attributes:
        search_info (BookInfo): TODO: type description here.
    ...
    def __init__(
        ...
        """Constructor for the BookInfoRemoteSearchQuery class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        if "SearchInfo" in dictionary.keys():
            search_info = (
                BookInfo.from_dictionary(dictionary.get("SearchInfo"))
    ...
    def to_xml_sub_element(self, root):
        ...
        """
        XmlUtilities.add_as_subelement(root, self.search_info, "BookInfo")
