...
from jellyfinapi.models.person_lookup_info import PersonLookupInfo
from jellyfinapi.utilities.xml_utilities import XmlUtilities


class PersonLookupInfoRemoteSearchQuery(object):

    """Implementation of the 'PersonLookupInfoRemoteSearchQuery' model.

    TODO: type model description here.

    Attributes:
        search_info (PersonLookupInfo): TODO: type description here.
    ...
    def __init__(
        ...
        """Constructor for the PersonLookupInfoRemoteSearchQuery class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        if "SearchInfo" in dictionary.keys():
            search_info = (
                PersonLookupInfo.from_dictionary(dictionary.get("SearchInfo"))
    ...
    def from_element(cls, root):
        ...
        search_info = XmlUtilities.value_from_xml_element(
            root.find("PersonLookupInfo"), PersonLookupInfo
        )
    ...
    def to_xml_sub_element(self, root):
        ...
        """
        XmlUtilities.add_as_subelement(root, self.search_info, "PersonLookupInfo")
