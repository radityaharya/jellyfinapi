...
class TraktSeasonId(object):

    """Implementation of the 'TraktSeasonId' model.
    ...
    Attributes:
        ...
        tvdb (int): TODO: type description here.
    ...
    def __init__(
        ...
        """Constructor for the TraktSeasonId class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        return cls(trakt, slug, tmdb, tvdb, tvrage)
    ...
    def from_element(cls, root):
        ...
        tvdb = XmlUtilities.value_from_xml_element(root.find("tvdb"), int)
