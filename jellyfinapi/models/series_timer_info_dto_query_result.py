...
class SeriesTimerInfoDtoQueryResult(object):

    """Implementation of the 'SeriesTimerInfoDtoQueryResult' model.

    TODO: type model description here.

    Attributes:
        items (list of SeriesTimerInfoDto): Gets or sets the items.
    ...
    def __init__(
        ...
        """Constructor for the SeriesTimerInfoDtoQueryResult class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        if "Items" in dictionary.keys():
            items = (
                [SeriesTimerInfoDto.from_dictionary(x) for x in dictionary.get("Items")]
    ...
    def from_element(cls, root):
        ...
        items = XmlUtilities.list_from_xml_element(
            root, "SeriesTimerInfoDto", SeriesTimerInfoDto
        )
    ...
    def to_xml_sub_element(self, root):
        ...
        """
        XmlUtilities.add_list_as_subelement(root, self.items, "SeriesTimerInfoDto")
