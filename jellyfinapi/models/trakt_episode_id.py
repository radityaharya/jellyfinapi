...
class TraktEpisodeId(object):

    """Implementation of the 'TraktEpisodeId' model.
    ...
    Attributes:
        ...
        tvdb (string): TODO: type description here.
        tvrage (string): TODO: type description here.
    ...
    def __init__(
        ...
        """Constructor for the TraktEpisodeId class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        tvdb = dictionary.get("tvdb") if "tvdb" in dictionary.keys() else APIHelper.SKIP
        tvrage = (
        ...
        return cls(trakt, slug, imdb, tmdb, tvdb, tvrage)
    ...
    def from_element(cls, root):
        ...
        tvdb = XmlUtilities.value_from_xml_element(root.find("tvdb"), str)
        tvrage = XmlUtilities.value_from_xml_element(root.find("tvrage"), str)
    ...
    def to_xml_sub_element(self, root):
        ...
        XmlUtilities.add_as_subelement(root, self.tvdb, "tvdb")
