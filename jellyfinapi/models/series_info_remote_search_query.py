...
from jellyfinapi.models.series_info import SeriesInfo
from jellyfinapi.utilities.xml_utilities import XmlUtilities


class SeriesInfoRemoteSearchQuery(object):

    """Implementation of the 'SeriesInfoRemoteSearchQuery' model.

    TODO: type model description here.

    Attributes:
        search_info (SeriesInfo): TODO: type description here.
    ...
    def __init__(
        ...
        """Constructor for the SeriesInfoRemoteSearchQuery class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        if "SearchInfo" in dictionary.keys():
            search_info = (
                SeriesInfo.from_dictionary(dictionary.get("SearchInfo"))
    ...
    def from_element(cls, root):
        ...
        search_info = XmlUtilities.value_from_xml_element(
            root.find("SeriesInfo"), SeriesInfo
        )
    ...
    def to_xml_sub_element(self, root):
        ...
        """
        XmlUtilities.add_as_subelement(root, self.search_info, "SeriesInfo")
