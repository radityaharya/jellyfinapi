...
from jellyfinapi.models.trailer_info import TrailerInfo
from jellyfinapi.utilities.xml_utilities import XmlUtilities


class TrailerInfoRemoteSearchQuery(object):

    """Implementation of the 'TrailerInfoRemoteSearchQuery' model.

    TODO: type model description here.

    Attributes:
        search_info (TrailerInfo): TODO: type description here.
    ...
    def __init__(
        ...
        """Constructor for the TrailerInfoRemoteSearchQuery class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        if "SearchInfo" in dictionary.keys():
            search_info = (
                TrailerInfo.from_dictionary(dictionary.get("SearchInfo"))
    ...
    def from_element(cls, root):
        ...
        search_info = XmlUtilities.value_from_xml_element(
            root.find("TrailerInfo"), TrailerInfo
        )
    ...
    def to_xml_sub_element(self, root):
        ...
        """
        XmlUtilities.add_as_subelement(root, self.search_info, "TrailerInfo")
