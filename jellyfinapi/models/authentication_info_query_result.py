...
from jellyfinapi.models.authentication_info import AuthenticationInfo
from jellyfinapi.utilities.xml_utilities import XmlUtilities


class AuthenticationInfoQueryResult(object):

    """Implementation of the 'AuthenticationInfoQueryResult' model.

    TODO: type model description here.

    Attributes:
        items (list of AuthenticationInfo): Gets or sets the items.
    ...
    def __init__(
        ...
        """Constructor for the AuthenticationInfoQueryResult class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        if "Items" in dictionary.keys():
            items = (
                [AuthenticationInfo.from_dictionary(x) for x in dictionary.get("Items")]
    ...
    def from_element(cls, root):
        ...
        """
        items = XmlUtilities.list_from_xml_element(
            root, "AuthenticationInfo", AuthenticationInfo
        )
    ...
    def to_xml_sub_element(self, root):
        ...
        """
        XmlUtilities.add_list_as_subelement(root, self.items, "AuthenticationInfo")
