...
class TimerInfoDtoQueryResult(object):

    """Implementation of the 'TimerInfoDtoQueryResult' model.

    TODO: type model description here.

    Attributes:
        items (list of TimerInfoDto): Gets or sets the items.
    ...
    def __init__(
        ...
        """Constructor for the TimerInfoDtoQueryResult class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        if "Items" in dictionary.keys():
            items = (
                [TimerInfoDto.from_dictionary(x) for x in dictionary.get("Items")]
    ...
    def from_element(cls, root):
        ...
        """
        items = XmlUtilities.list_from_xml_element(root, "TimerInfoDto", TimerInfoDto)
    ...
    def to_xml_sub_element(self, root):
        ...
        """
        XmlUtilities.add_list_as_subelement(root, self.items, "TimerInfoDto")
