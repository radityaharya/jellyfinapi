...
from jellyfinapi.models.activity_log_entry import ActivityLogEntry
from jellyfinapi.utilities.xml_utilities import XmlUtilities


class ActivityLogEntryQueryResult(object):

    """Implementation of the 'ActivityLogEntryQueryResult' model.

    TODO: type model description here.

    Attributes:
        items (list of ActivityLogEntry): Gets or sets the items.
    ...
    def __init__(
        ...
        """Constructor for the ActivityLogEntryQueryResult class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        if "Items" in dictionary.keys():
            items = (
                [ActivityLogEntry.from_dictionary(x) for x in dictionary.get("Items")]
    ...
    def from_element(cls, root):
        ...
        items = XmlUtilities.list_from_xml_element(
            root, "ActivityLogEntry", ActivityLogEntry
        )
    ...
    def to_xml_sub_element(self, root):
        ...
        """
        XmlUtilities.add_list_as_subelement(root, self.items, "ActivityLogEntry")
