...
from jellyfinapi.models.artist_info import ArtistInfo
from jellyfinapi.utilities.xml_utilities import XmlUtilities


class ArtistInfoRemoteSearchQuery(object):

    """Implementation of the 'ArtistInfoRemoteSearchQuery' model.

    TODO: type model description here.

    Attributes:
        search_info (ArtistInfo): TODO: type description here.
    ...
    def __init__(
        ...
        """Constructor for the ArtistInfoRemoteSearchQuery class"""
    ...
    def from_dictionary(cls, dictionary):
        ...
        if "SearchInfo" in dictionary.keys():
            search_info = (
                ArtistInfo.from_dictionary(dictionary.get("SearchInfo"))
    ...
    def from_element(cls, root):
        ...
        search_info = XmlUtilities.value_from_xml_element(
            root.find("ArtistInfo"), ArtistInfo
        )
    ...
    def to_xml_sub_element(self, root):
        ...
        """
        XmlUtilities.add_as_subelement(root, self.search_info, "ArtistInfo")
