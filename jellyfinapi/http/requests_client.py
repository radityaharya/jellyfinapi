...
from jellyfinapi.http.http_client import HttpClient
from jellyfinapi.http.http_method_enum import HttpMethodEnum
from jellyfinapi.http.http_response import HttpResponse
...
class RequestsClient(HttpClient):
    ...
    def __init__(
        ...
        if http_client_instance == None:
            self.create_default_http_cient(
                timeout,
                cache,
                max_retries,
                backoff_factor,
